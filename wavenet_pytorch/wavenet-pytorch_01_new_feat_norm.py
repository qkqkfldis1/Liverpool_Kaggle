...
class Classifier(nn.Module):
    def __init__(self, basic_block=wave_block):
        ...
        self.layer1 = self._make_layers(16, 32, 3, 12)
        self.layer2 = self._make_layers(32, 64, 3, 8)
        self.layer3 = self._make_layers(64, 128, 3, 4)
        self.layer4 = self._make_layers(128, 256, 3, 1)
